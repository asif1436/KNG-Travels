...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'asif1436.pythonanywhere.com', '34.122.202.32']
...
PWA_APP_ICONS = [ {
            "src": "../../static/assets/img/kng1.png",            
            "sizes": "600x480"
        },
        {
            "src": "../../static/assets/img/kng1.png",
...
PWA_APP_ICONS_APPLE = [ { 'src': "../../static/assets/img/kng1.png", 'sizes': '160x160' } ] 
PWA_APP_SPLASH_SCREEN = [ { 'src': "../../static/assets/img/kng1.png", 'media': '(device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2)' } ] 
PWA_APP_DIR = 'ltr' 
PWA_APP_LANG = 'en-US'
